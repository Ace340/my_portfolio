<!-- Context: project-intelligence/nav | Priority: high | Version: 1.1 | Updated: 2026-06-30 -->
...
| Understand the "how" | `technical-domain.md` | React 19 + Vite + GSAP + Tailwind v4 stack, animation & styling patterns |
